...
function successToast(message){
    $('.toast').toast('hide');
    $('.status').prepend('<img src="http://local.nn.com/asset/img/icons/error.png">');
    $('.status').html('<b style="color:green;">Success</b>');
...
function errorToast(message){
    $('.toast').toast('hide');
    $('.status').prepend('<img src="http://local.nn.com/asset/img/icons/error.png">');
    $('.status').html('<b style="color:red;">Error</b>');
    $('.toast-body').text(message);
    $('.toast').toast('show');
}

var api_host = 'http://local.api.com';
