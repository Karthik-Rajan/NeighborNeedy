			...
			<div class="tr-accordion" id="accordion">
				...
				<div class="card">
					<div class="card-header" id="heading-2">
						<button class="collapsed" data-toggle="collapse" data-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">Vel illum dolore eu?</button>
					</div>
				...
				<div class="card">
					<div class="card-header" id="heading-3">
						<button class="collapsed" data-toggle="collapse" data-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">Nam liber tempor cum soluta?</button>
					</div>
				...
				<div class="card">
					<div class="card-header" id="heading-4">
						<button class="collapsed" data-toggle="collapse" data-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">Claritas est etiam processus dynamicus?</button>
					</div>
				...
				<div class="card">
					<div class="card-header" id="heading-5">
						<button class="collapsed" data-toggle="collapse" data-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">Duis autem vel eum iriure dolor?</button>
					</div>
				...
				<div class="card">
					<div class="card-header" id="heading-6">
						<button class="collapsed" data-toggle="collapse" data-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">Nam liber tempor cum soluta?</button>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 text-center">
					...
					<a href="https://demo.themeregion.com/trade/contact-us.html" class="btn btn-primary">Contact Us</a>
				</div>
			</div>
		</div>
	</section>
