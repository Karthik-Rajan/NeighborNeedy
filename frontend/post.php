...
<section id="main" class="clearfix ad-details-page">
	<div class="container">
		...
		<div class="adpost-details">
			<div class="row">
				<div class="col-lg-8">
					<form action="https://demo.themeregion.com/trade/ad-post-details.html#">
						<fieldset>
							<div class="section postdetails">
								...
								<div class="form-group selected-product">
									<ul class="select-category list-inline">
										<li>
											<a href="https://demo.themeregion.com/trade/ad-post.html">
												<span class="select">
													<img src="./ad post 2_files/2.png" alt="Images" class="img-fluid">
												</span>
												Electronics &amp; Gedgets
											</a>
										</li>
										<li class="active">
											<a href="https://demo.themeregion.com/trade/ad-post-details.html#">Phablet &amp; Tablets</a>
										</li>
									</ul>
									<a class="edit" href="https://demo.themeregion.com/trade/ad-post-details.html#"><i class="fa fa-pencil"></i>Edit</a>
								</div>
							...
							<div class="section">
								...
								<p>More replies means more interested buyers. With lots of interested buyers, you have a better chance of selling for the price that you want. <a href="https://demo.themeregion.com/trade/ad-post-details.html#">Learn more</a></p>
							...
							<div class="checkbox section agreement">
								<label for="send">
									...
									Send me Trade Email/SMS Alerts for people looking to buy mobile handsets in www By clicking "Post", you agree to our <a href="https://demo.themeregion.com/trade/ad-post-details.html#">Terms of Use</a> and <a href="https://demo.themeregion.com/trade/ad-post-details.html#">Privacy Policy</a> and acknowledge that you are the rightful owner of this item and using Trade to find a genuine buyer.
								</label>
				...
				<div class="col-lg-4">
					<div class="section quick-rules">
						<h4>Quick rules</h4>
						<p class="lead">Posting an ad on <a href="https://demo.themeregion.com/trade/ad-post-details.html#">Trade.com</a> is free! However, all ads must follow our rules:</p>
						<ul>
